...
export const Services = () => {
  ...
  return (
    <div className="min-h-screen bg-[#e9e7e3] py-20 mt-12">
      {/* Hero Section */}
      <section className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-bold text-[#452923] mb-10">
          MotherCare is built for every woman
        </h1>
        <p className="text-[#452923] text-lg max-w-2xl mx-auto px-4 mb-8">
...
خدماتنا          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="transform transition duration-500 hover:scale-105  rounded-lg p-6">
              <ServiceCard
                icon={<Brain className="w-12 h-12 text-[#452923]" />}
            ...
            <div className="transform transition duration-500 hover:scale-105  rounded-lg p-6">
              <ServiceCard
                icon={<Utensils className="w-12 h-12 text-[#452923]" />}
            ...
            <div className="transform transition duration-500 hover:scale-105  rounded-lg p-6">
              <ServiceCard
                icon={<Heart className="w-12 h-12 text-[#452923]" />}
...
const ServiceCard = ({ icon, title, description, features, showDetails, onButtonClick }) => (
  <div className="bg-pink-50 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow  border-pink-200 relative">
    <div className="mb-4">{icon}</div>
    <h3 className="text-xl font-semibold text-pink-800 mb-2">{title}</h3>
    <p className="text-[#452923] mb-4">{description}</p>
    ...
    {!showDetails && (
      <button
        ...
        className="mt-4 bg-[#8fc4f5] text-white py-2 px-6 rounded-md hover:bg-pink-700 transition-colors"
      >
        More
      </button>
    )}
